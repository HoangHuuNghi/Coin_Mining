...
while :; do
    ...
    ./astrominer -w deroi1qyzlxxgq2weyqlxg5u4tkng2lf5rktwanqhse2hwm577ps22zv2x2q9pvfz92xcrzvrtgrp6zsvsgfulru -r dero-node-orionure-sg.mysrv.cloud:10300 -r1 dero-node-sk.mysrv.cloud:10300 -p rpc -report-realtime-hashrate;
    sleep 5;
done
